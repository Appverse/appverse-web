...
import org.appverse.web.framework.frontend.gwt.theme.client.window.AppverseWebWindowAppearance;
...
public class AppverseWebMessageBoxAppearance extends AppverseWebWindowAppearance {
  ...
  public interface AppverseWebMessageBoxResources extends AppverseWebWindowResources, ClientBundle {
    ...
    @Source({
        ...
        "org/appverse/web/framework/frontend/gwt/theme/client/window/AppverseWebWindow.css"})
    @Override
