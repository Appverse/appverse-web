...
public class DefaultLabelToolItemAppearance implements LabelToolItemAppearance {
  ...
  public DefaultLabelToolItemAppearance() {
    this(GWT.<LabelToolItemResources> create(LabelToolItemResources.class));
  }

  public DefaultLabelToolItemAppearance(LabelToolItemResources resources) {
