...
public class DefaultColumnHeaderAppearance implements ColumnHeaderAppearance {
  ...
  public DefaultColumnHeaderAppearance() {
    this(GWT.<ColumnHeaderResources> create(ColumnHeaderResources.class));
  }

  public DefaultColumnHeaderAppearance(ColumnHeaderResources resources) {
