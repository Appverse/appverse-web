...
public class DefaultTriggerFieldAppearance extends ValueBaseFieldDefaultAppearance implements TriggerFieldAppearance {
  ...
  public DefaultTriggerFieldAppearance() {
    this(GWT.<TriggerFieldResources> create(TriggerFieldResources.class));
  }

  public DefaultTriggerFieldAppearance(TriggerFieldResources resources) {
    super(resources);
