 ...
 */
package org.appverse.web.framework.frontend.gwt.theme.client.resizable;
...
public class DefaultResizableAppearance extends ResizableBaseAppearance {
  ...
  public DefaultResizableAppearance() {
    this(GWT.<BlueResizableResources> create(BlueResizableResources.class));
  }

  public DefaultResizableAppearance(ResizableResources resources) {
    super(resources);
  }
