...
public class DefaultDatePickerAppearance extends DatePickerBaseAppearance {
  ...
  public DefaultDatePickerAppearance() {
    this(GWT.<BlueDatePickerResources> create(BlueDatePickerResources.class));
  }

  public DefaultDatePickerAppearance(BlueDatePickerResources resources) {
    super(resources);
  }
