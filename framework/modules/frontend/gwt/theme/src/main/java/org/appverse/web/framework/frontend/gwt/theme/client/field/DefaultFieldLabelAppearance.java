...
public class DefaultFieldLabelAppearance implements FieldLabelAppearance {
  ...
  public DefaultFieldLabelAppearance() {
    this(GWT.<FieldLabelResources> create(FieldLabelResources.class), GWT.<FieldLabelTemplate> create(FieldLabelTemplate.class));
  }

  public DefaultFieldLabelAppearance(FieldLabelResources resources, FieldLabelTemplate template) {
