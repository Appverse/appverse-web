...
public class DefaultTextFieldAppearance extends ValueBaseFieldDefaultAppearance implements TextFieldAppearance {
  ...
  public DefaultTextFieldAppearance(TextFieldResources resources) {
    super(resources);
